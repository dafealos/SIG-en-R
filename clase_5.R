...
ggplot() + geom_sf(data = Casos_Activos_Valpo, aes(fill = Activos_por_100.000)) + 
        facet_wrap(~Fecha) + scale_fill_gradientn(name = "Activos por 100.000 hab", 
                                                  colours = heat.colors(30)) #con rev(heat.colors(30))) invertimos a escala
...
#Escala por bins
ggplot() + geom_sf(data = Casos_Activos_Valpo, aes(fill = Activos_por_100.000)) + 
        facet_wrap(~Fecha) + scale_fill_binned(name = "Activos por 100.000 hab")#la divide en 4 categorias
