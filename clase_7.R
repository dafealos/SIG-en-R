...
TDF_NDVI <- mt_subset(product = "MOD13Q1", lat = 4.57, lon = -74.29, 
                      band = "250m_16_days_NDVI", start = "2020-01-01", end = "2020-06-01", 
                      km_lr = 50, km_ab = 50, site_name = "colombia", internal = TRUE, 
                      progress = T)
...
dates <- mt_dates(product = "MOD13Q1", lat = 4.57, lon = -74.29) %>% 
